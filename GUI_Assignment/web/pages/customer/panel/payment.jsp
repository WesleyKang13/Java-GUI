...
<script>
    ...
    body.querySelector(".nav-link.payment").classList.add("active");
</script>

<link rel="stylesheet" href="<%=ROOT_PATH+"css/customer/panel/payment.css"%>">
...
<%!
            ...
            %>
            <div class="filter">
                <button type="button" <%=validateFilter("all", filter)%> onclick="window.location.href='<%=ROOT_PATH+"pages/customer/panel/LoadPayment"%>'">All</button>
            ...
            <script>
                const filterMethods = (type) => {
                  const url = "<%=ROOT_PATH+"pages/customer/panel/LoadPayment/filter/"%>" + type;
            ...
            <table class="table horizontal-table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <button class="actionRoundBtn" onclick="location.href='<%=ROOT_PATH+"pages/customer/panel/LoadPayment/paymentDetailID/"+p.getPaytId()%>'"><i class="fa-solid fa-circle-info fa-spin"></i></button>
                        </td>
                    </tr>
                    <% } %>
                </tbody>
    ...
    %>
        <div class="paymentDetail container">
            <div class="text">
            ...
            <div class="detail-action">
                <button class="paymentBackBtn backBtn btn" onclick="location.href='<%=ROOT_PATH+"pages/customer/panel/LoadPayment"%>'">Back</button>
            </div>
        </div>
    <% } %>
</main>
